...
<form method="post" action="{{ route('dashboard.user.update', $user->id) }}">
    ...
    <div class="mb-10">
        ...
        <div class="flex items-center">
            <input @if($user->role == 'pengelola') checked @endif id="pengelola" type="radio" value="pengelola" name="role" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
