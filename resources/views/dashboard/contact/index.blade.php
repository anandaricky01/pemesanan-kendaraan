...
<form method="get" action="{{ route('dashboard.contact.index') }}" class="mb-5">
    <div class="">
...
<div class="col-span-2 relative overflow-x-auto shadow-md sm:rounded-lg border">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-slate-50 dark:text-white dark:bg-gray-800">
            Data Kontak
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Data Kontak dapat ditambah, diubah, atau dihapus oleh admin</p>
        </caption>
                ...
                @foreach ($contacts as $item)
                    <tr class="bg-slate-50 border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <form id="hapus-laporan" action="{{ route('dashboard.contact.delete', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Yakin ingin menghapus Kontak {{ $item->name }}?</h3>
