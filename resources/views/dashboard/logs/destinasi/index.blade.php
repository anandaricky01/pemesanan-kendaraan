    ...
    <form method="get" action="{{ route('dashboard.destinasi.index') }}">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search"
                ...
                name="search" placeholder="Cari judul destinasi..." value="{{ request('search')}}">
...
<section id="tabel-destinasi" class="mt-3">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption
                ...
                <p>
                    Daftar Log destinasi
                </p>
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                    Semua perubahan data destinasi tercatat di sini
                </p>
            </caption>
            ...
            <tbody>
                @if ($destinasi_logs->count() > 0)
                @foreach ($destinasi_logs as $des)
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td>
                        <a href="{{ route('dashboard.destinasi_logs.show', $des->id) }}">
...
<div class="mt-5 text-center">
    {{ $destinasi_logs->links('pagination::tailwind') }}
</div>
@endsection
