    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption
                ...
                <a href="{{ route('riwayat_pemesanan.export') }}" class="relative md:absolute md:top-7 md:right-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Export</a>
                <br class="md:hidden">
                <p class="mt-5 md:mt-0">
                    Daftar Riwayat Pemesanan
                </p>
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                    Riwayat Pemesanan yang disetujui akan muncul di sini
                </p>
            </caption>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td>
                        <a href="{{ route('dashboard.riwayat.pemesanan.detail', $pem->id) }}">
                            <button
