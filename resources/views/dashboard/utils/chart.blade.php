<script>
    function updateDataInViewChart(data_api){
        ...
        if(data_api.success == true && data_api.data != null){
            ...
            tester.textContent = 'Terdapat masalah pada server/Data masih kosong!';
            tester.setAttribute('class', 'p-5 text-center')
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        getDataFromAPIChart(); // Memanggil fungsi getDataFromAPIChart saat dokumen sudah siap
    });

    setInterval(getDataFromAPIChart, 5000);
  </script>
